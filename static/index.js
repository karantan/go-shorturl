...
var $author$project$Index$Init = {$: 'Init'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Index$init = function (_v0) {
	return _Utils_Tuple2(
		{prefix: '', serverMessage: '', state: $author$project$Index$Init, url: ''},
...
var $author$project$Index$Failure = {$: 'Failure'};
var $author$project$Index$Loading = {$: 'Loading'};
var $author$project$Index$Success = {$: 'Success'};
var $author$project$Index$errorToString = function (error) {
	switch (error.$) {
		case 'BadUrl':
			var url = error.a;
...
var $author$project$Index$GotResponse = function (a) {
	return {$: 'GotResponse', a: a};
};
var $author$project$Index$Response = F2(
...
var $author$project$Index$decodeResponse = A3(
	...
	A3(
		...
		$elm$json$Json$Decode$succeed($author$project$Index$Response)));
...
var $author$project$Index$encodeModel = function (record) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'prefix',
				$elm$json$Json$Encode$string(record.prefix)),
				_Utils_Tuple2(
				'url',
...
var $author$project$Index$sendRequest = function (model) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Index$encodeModel(model)),
			expect: A2($elm$http$Http$expectJson, $author$project$Index$GotResponse, $author$project$Index$decodeResponse),
			url: '/create'
		});
};
		...
		switch (msg.$) {
			...
			case 'SubmitPost':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{state: $author$project$Index$Loading}),
					$author$project$Index$sendRequest(model));
			default:
				var resp = msg.a;
				if (resp.$ === 'Ok') {
					var serverResponse = resp.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{serverMessage: serverResponse.message, state: $author$project$Index$Success}),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = resp.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								serverMessage: $author$project$Index$errorToString(err),
								state: $author$project$Index$Failure
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
var $author$project$Index$SubmitPost = {$: 'SubmitPost'};
var $author$project$Index$UpdatePrefix = function (a) {
	return {$: 'UpdatePrefix', a: a};
};
var $author$project$Index$UpdateUrl = function (a) {
...
var $author$project$Index$formDisabled = function (_v0) {
	var state = _v0.state;
	return A2(
		$elm$core$List$member,
		state,
		_List_fromArray(
			[$author$project$Index$Failure, $author$project$Index$Success, $author$project$Index$Init])) ? false : true;
};
...
var $perzanko$elm_loading$Loading$DoubleBounce = {$: 'DoubleBounce'};
...
var $author$project$Index$viewResult = function (model) {
	var _v0 = model.state;
	switch (_v0.$) {
		case 'Init':
		...
		case 'Failure':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.serverMessage)
					]));
		case 'Loading':
			return A2(
				$elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								$perzanko$elm_loading$Loading$DoubleBounce,
								_Utils_update(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Go Small URL')
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$author$project$Index$viewResult(model)
					])),
				A2(
				$elm$html$Html$label,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$for('prefix'),
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$id('prefix'),
						$elm$html$Html$Attributes$class('form-control'),
						$elm$html$Html$Attributes$placeholder('Prefix (e.g. sc2)'),
						$elm$html$Html$Events$onInput($author$project$Index$UpdatePrefix)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$label,
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$class('form-control'),
						$elm$html$Html$Attributes$placeholder('URL (e.g. https://google.com)'),
						$elm$html$Html$Attributes$required(true),
						$elm$html$Html$Events$onInput($author$project$Index$UpdateUrl)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$class('btn-lg'),
						$elm$html$Html$Attributes$class('btn-primary'),
						$elm$html$Html$Attributes$class('btn-block'),
						$elm$html$Html$Attributes$type_('button'),
						$elm$html$Html$Attributes$disabled(
						$author$project$Index$formDisabled(model)),
						$elm$html$Html$Events$onClick($author$project$Index$SubmitPost)
					]),
				_List_fromArray(
					[
